    ...
    <section class="space-y-6">
        <div class="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            <div>
                ...
                <h2 class="mt-2 text-3xl font-semibold tracking-tight text-slate-950">Students attending {{ $class->class_name }}</h2>
            </div>
        ...
        <div class="overflow-x-auto">
            <table class="w-full">
                ...
                <tbody class="divide-y divide-slate-200">
                    ...
                    @empty
                        <tr>
                            <td colspan="4" class="px-6 py-8 text-center text-sm text-slate-500">No students attend this class yet.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
