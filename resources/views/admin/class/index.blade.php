...
@section('header-title')
    <p class="text-sm font-semibold uppercase tracking-[0.22em] text-sky-700">Manajemen Kelas</p>
@endsection
...
@section('content')
    ...
    <section class="space-y-6">
        <div class="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            <div>
                <h2 class="mt-2 text-3xl font-semibold tracking-tight text-slate-950">Atur kelompok belajar dan kelas</h2>
            </div>
            ...
            <table class="w-full">
                <thead>
                    <tr class="border-b border-slate-200 bg-slate-50">
                        <th class="px-6 py-4 text-left text-sm font-semibold text-slate-600">Nama Kelas</th>
                        <th class="px-6 py-4 text-left text-sm font-semibold text-slate-600">Kode Kelas</th>
                        ...
                        <tr class="transition-colors hover:bg-slate-50">
                            ...
                            <td class="px-6 py-4 text-sm">
                                <div class="flex gap-2">
                                    <a href="{{ route('admin.manage-class.index', $class['id']) }}" class="rounded-lg px-3 py-2 text-xs font-semibold text-emerald-700 transition-colors hover:bg-emerald-100">Kelola</a>
                                    <a href="{{ route('admin.class.edit', $class['id']) }}" class="rounded-lg px-3 py-2 text-xs font-semibold text-sky-700 transition-colors hover:bg-sky-100">Ubah</a>
