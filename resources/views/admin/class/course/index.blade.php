                        ...
                        <tr class="transition-colors hover:bg-slate-50">
                            ...
                            <td class="px-6 py-4 text-sm">
                                <div class="flex gap-2">
                                    <a href="{{ route('admin.manage-class.course.edit', [$class->id, $course->id]) }}" class="rounded-lg px-3 py-2 text-xs font-semibold text-sky-700 transition-colors hover:bg-sky-100">Edit</a>
