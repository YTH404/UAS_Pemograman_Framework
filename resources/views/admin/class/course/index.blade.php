                ...
                <tbody class="divide-y divide-slate-200">
                    @forelse ($courses as $course)
                        <tr class="transition-colors hover:bg-slate-50">
                            ...
                            <td class="px-6 py-4 text-sm text-slate-600">{{ $course->teacher?->name ?? 'No teacher yet' }}</td>
                    ...
                    @empty
                        <tr>
                            <td colspan="3" class="px-6 py-8 text-center text-sm text-slate-500">No courses for this class yet.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
