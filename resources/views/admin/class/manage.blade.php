...
@section('header-title')
    <p class="text-sm font-semibold uppercase tracking-[0.22em] text-sky-700">Manage Classes</p>
@endsection
...
@section('content')
    <section class="space-y-2">
        ...
        <p class="text-sm text-slate-600">Select the class data you want to review or update.</p>
    </section>
    ...
    <section class="grid gap-5 lg:grid-cols-2">
        <a href="{{ route('admin.manage-class.course.index', $class->id) }}" class="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-xl shadow-slate-200/70 transition hover:-translate-y-0.5 hover:shadow-2xl hover:shadow-slate-200">
            ...
            <h3 class="mt-3 text-2xl font-semibold tracking-tight text-slate-950">Courses</h3>
            <p class="mt-2 text-sm text-slate-600">{{ $class->courses_count }} courses connected to this class.</p>
        </a>
        ...
        <a href="{{ route('admin.manage-class.student.index', $class->id) }}" class="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-xl shadow-slate-200/70 transition hover:-translate-y-0.5 hover:shadow-2xl hover:shadow-slate-200">
            <p class="text-sm font-semibold uppercase tracking-[0.22em] text-sky-700">Students</p>
            <h3 class="mt-3 text-2xl font-semibold tracking-tight text-slate-950">Students</h3>
            <p class="mt-2 text-sm text-slate-600">{{ $class->student_classes_count }} students enrolled in this class.</p>
        </a>
    </section>
