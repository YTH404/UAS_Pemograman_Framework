...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{ config('app.name', 'Campus LMS') }} | Manage Classes</title>
    ...
    <body class="min-h-screen bg-slate-50 text-slate-900 antialiased">
        @php
            $navItems = [
                ...
                ['label' => 'Manage Class', 'route' => route('admin.manage-class'), 'active' => true],
            ];
                                    ...
                                    <tr class="transition-colors hover:bg-slate-50">
                                        ...
                                        <td class="px-6 py-4 text-sm">
                                            <div class="flex gap-2">
                                                <button class="rounded-lg px-3 py-2 text-xs font-semibold text-yellow-700 transition-colors hover:bg-sky-100">Manage</button>
